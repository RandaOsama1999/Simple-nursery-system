...
$Subject_ID="SELECT Subject_ID FROM n_system.teacher WHERE TeacherMail='$Email'";
$result= mysqli_query($conn,$Subject_ID);
...
$subjectfromtable="SELECT SubjectName From n_system.subject WHERE Subject_ID='$s1' ";
            $result3= mysqli_query($conn2,$subjectfromtable);
            $row2 = $result3->fetch_assoc();
            $s=$row2["SubjectName"];
            ////////////////////////////////////
            $ScheduleInfo="SELECT * FROM n_system.schedule WHERE Subject_ID='$s1' AND Day='Sunday' " ;
            $result2= mysqli_query($conn2,$ScheduleInfo);
...
echo "<tr>";
         ...
         ////////////////////////////////////
         $Monday="SELECT * FROM n_system.schedule WHERE Subject_ID='$s1' AND Day='Monday'" ;
         $result3= mysqli_query($conn2,$Monday);
...
echo "<tr>";
      ...
      ////////////////////////////////////
      $Tuesday="SELECT * FROM n_system.schedule WHERE Subject_ID='$s1' AND Day='Tuesday'" ;
      $result4= mysqli_query($conn2,$Tuesday);
...
echo "<tr>";
   ...
   ////////////////////////////////////
   $Wednesday="SELECT * FROM n_system.schedule WHERE Subject_ID='$s1' AND Day='Wednesday' " ;
...
echo "<tr>";
 ...
 ////////////////////////////////////
 $Thursday="SELECT * FROM n_system.schedule WHERE Subject_ID='$s1' AND Day='Thursday' " ;
