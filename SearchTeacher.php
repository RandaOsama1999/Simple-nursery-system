  ...
  $email = $_SESSION['email'];
    ...
    $name = "root";
            ...
            if(isset($_POST['search'])){
                ...
                $sqlone = " SELECT * FROM n_system.teacher WHERE TeacherMail='$teachermail' ";
                ...
                {  
                    if($rowT==true)
                    {
                        ...
                        header('location: EditTeacherData.php?teachermail='.$teachermail);
                        $count=$count+1;
    ...
    <head>
        ...
        $(document).ready(function(){
            $('.search-box input').keyup(function(){
                ...
                if(inputVal.length){
                    $.get("backend-searchteacher.php", {term: inputVal}).done(function(data){
...
body{
    ...
    <title>Smart Kids nursery</title>
        ...
        <script>
            ...
            y2=document.forms["myForm"]["teachermail"].value;
        ...
        <div id="data">
            <h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Enter the mail of the teacher you want to Edit</h2>
            <br>
            <form id='searchform' method='post' name='myForm' onsubmit='return validateForm()'>
            <div class="search-box" >
                <input type='text' autocomplete="off" placeholder="Search Mail" name='teachermail'>
                <div class="result"></div>
            </div>
                    
            <button class='btn' name='search'  style='position: absolute; margin-left:0.6%;'>Search</button>
            </form>
            <br>
