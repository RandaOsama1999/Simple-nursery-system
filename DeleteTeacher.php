    ...
    <title>Smart Kids nursery</title>
        ...
        <?php
            ...
            while($row = $result->fetch_assoc()){     
                if($row==true)
                {
                    echo '<h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Enter the mail of the teacher you want to Remove</h2>';
            ...
            if(isset($_POST['remove'])){
                ...
                $sqlt="SELECT * FROM n_system.teacher WHERE TeacherMail='$teacherMail'";
                $resultt=$conn->query($sqlt);
                while($rowt = $resultt->fetch_assoc()){     
                    if($rowt==true)
                    {
                        $sqlTwo="DELETE FROM n_system.teacher WHERE TeacherMail='$teacherMail'";
                        $sqlThree="DELETE FROM n_system.users WHERE Mail='$teacherMail'";
