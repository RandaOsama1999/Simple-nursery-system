...
li button.active {
    ...
    <title>Smart Kids nursery</title>
        ...
        <br>
        <div id="data">
            <!--<h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Enter the mail and the first name of the child you want to send the interview info to</h2>
                    -->
          <br>
        <?php
        if (isset($_SESSION['email']))
        {
            ...
            if ($conn->connect_error) {
                die("Connection failed: " . $conn->connect_error);
                    ...
                    $sqlT="SELECT * FROM n_system.users WHERE Mail='$email'";
                    ...
                    while($rowTwo = $result->fetch_assoc()){
                        if($rowTwo==true)
                        {
                            ...
                            $sqlThree="SELECT * FROM n_system.interview WHERE Child_ID='$Child_ID'";
                            ...
                            while($rowThree = $resultTwo->fetch_assoc()){
                                if($rowThree==true)
                                {
                                    ...
                                    $sqlFour="SELECT * FROM n_system.manager WHERE Manager_ID='$Manager_ID'";
                                    $resultThree=$conn->query($sqlFour);
                                    while($rowFour = $resultThree->fetch_assoc()){
                                        if($rowFour==true)
                                        {
                                            $ManagerMail=$rowFour['ManagerMail'];
                                            $sqlFive="SELECT * FROM n_system.users WHERE Mail='$ManagerMail'";
                                            $resultFour=$conn->query($sqlFive);
                                            while($rowFive = $resultFour->fetch_assoc()){
                                                if($rowFive==true)
                                                {
                                                    $Manager_Name=$rowFive['FirstName'];
                                                    if($Age<5)
                                                    {
                                                        echo '<h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Interview info</h2>';
                                                        echo "<br>";
                                                        echo "<p style='padding-left:30%; font-size:medium;'><b>Dear Parent, </b></p>";
                                                        echo "<br>";
                                                        echo "<p style='text-align:center; font-size:medium;'>Smart kids Nursery is so happy that you are interested
                                                        in applying for your child to be a part of us, </p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>we are so excited to meet you and know more about your child.</p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>We want to inform you that your interview will take place on $Date 
                                                        at $Time in the nursery.</p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>We are waiting for you. Thank you.</p>";
                                                        echo "<p style='padding-left:65%; font-size:medium;'><b>Manager, </b></p>";
                                                        echo "<p style='padding-left:65%; font-size:medium;'><b>$Manager_Name</b></p>";
                                                        echo "<form id='searchform' method='get'>
                                                        <button class='btn' name='back' style='margin-left:48%; margin-bottom:2%;'>Back</button></form>";
                                                    }
                                                    else{
                                                        echo '<h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Interview info</h2>';
                                                        echo "<br>";
                                                        ...
                                                        echo "<p style='text-align:center; font-size:medium;'>Smart kids Nursery is so happy that you are interested
                                                        in applying for your child to be a part of us, </p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>we are so excited to meet you and your child.</p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>We want to inform you that your interview will take place on $Date 
                                                        at $Time in the nursery.</p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>Kindly note that your child will have an interview too.</p>";
                                                        echo "<p style='text-align:center; font-size:medium;'>We are waiting for you. Thank you.</p>";
                                                        echo "<p style='padding-left:65%; font-size:medium;'><b>Manager, </b></p>";
                                                        echo "<p style='padding-left:65%; font-size:medium;'><b>$Manager_Name</b></p>";
                                                        echo "<form id='searchform' method='get'>
