    ...
    <title>Smart Kids nursery</title>
        ...
        <?php
            ...
            { 
                if($rowTwo==true)
               {
                    $childmail = $_GET['childmail'];
                    $sqlone = " SELECT Hobby, School,Parent_ID FROM n_system.child WHERE ChildMail='$childmail' AND State_ID=2";
                    ...
                    {  
                        if($rowT==true)
                        {
                            ...
                            $sqlTwo = " SELECT * FROM n_system.users WHERE Mail='$childmail'";
                    ...
                    {  
                        ...
                        $sqlThree="UPDATE n_system.users SET FirstName='$FirstName', LastName='$LastName' , FamilyName='$FamilyName',
                         ...
                         Home='$Home', Address='$Address',Password='$UserP' WHERE Mail='$childmail'";


                        $sqlFour="UPDATE  n_system.child SET Hobby='$Hobby', School='$School' WHERE ChildMail='$childmail'";
