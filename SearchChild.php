  ...
  if(isset($_GET['back']))
  {
    ...
    $name = "root";
            ...
            if(isset($_POST['search'])){
                ...
                $sqlone = " SELECT * FROM n_system.child WHERE ChildMail='$childmail' AND State_ID=2";
                ...
                {  
                    if($rowT==true)
                    {
                            ...
                            header('location: EditChildData.php?childmail='.$childmail);
                            $count=$count+1;
...
body{
    ...
    <title>Smart Kids nursery</title>
        ...
        <div id="data">
            <h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Enter the mail of the child you want to Edit</h2>
            <br>
