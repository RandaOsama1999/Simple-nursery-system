...
li button.active {
    ...
    <title>Smart Kids nursery</title>
        ...
        <br>
        <div id="data">
            <h2 style="text-align:center; color: rgba(196, 90, 143, 0.836);">Accepting Page</h2>
            ...
            <p style='text-align:center; font-size:medium;'>
                ...
                <select name="parentmail">
                    <?php
                        if (isset($_SESSION['email']))
                        {
                            ...
                            $query="SELECT * FROM n_system.child WHERE State_ID=3";
                            ...
                            if(isset($_POST['accept'])){
                                ...
                                $sqlFive="UPDATE n_system.child SET State_ID=2 WHERE ChildMail='$Mail'";
                                $resultFive = $conn->query($sqlFive);
                                $sqlN="DELETE FROM n_system.interview WHERE Child_ID='$Child_ID'";
                ...
                <button class='btn' name='accept' style='margin-left:48%; margin-bottom:2%;margin-top:2%;'>Accept</button>
