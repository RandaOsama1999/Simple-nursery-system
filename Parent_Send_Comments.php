...
$conn = new mysqli("localhost", "root", "","n_system");
            ...
            if(isset($_POST['send']))
            {
              ...
              $checking=false;
                ...
                $sqlsearch = "SELECT Mail FROM n_system.users WHERE userType_ID='3' ";
                ...
                while($row = $result->fetch_assoc())
                {
                    if($row==true)
                    {
                    if($row["Mail"]==$TeacherEmail)
                    { 
                        $mysql="INSERT INTO comments (MailT,MailP,Pcomment,Date ,Time) 
                        VALUES ('$TeacherEmail','$Email','$Message','$date','$time')";
    ...
    <script>
            ...
            y2=document.forms["myForm"]["TeacherEmail"].value;
        ...
        <div class="FORM">
              ...
              <div >
                ...
                <hr>
                <label for="childn"><b>Teacher's Email</b></label>
                <input type="text" placeholder="Enter Teacher's Email" name="TeacherEmail" required>
